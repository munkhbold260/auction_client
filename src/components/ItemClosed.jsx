...
export default function ItemClosed({ item }) {
      ...
      try {
        ...
        if (Date.now() >= exp * 1000) {
          ...
          if (item.item_type === "open") {
            ...
            router.push(`/auction_closed/${item.item_id}`);
          }
        }
      } catch (err) {
  ...
  return (
    <div className="p-6 w-full max-w-4xl h-full flex flex-col items-center mx-auto bg-gray-100 shadow-xl rounded-lg">
